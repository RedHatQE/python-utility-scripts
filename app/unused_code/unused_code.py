...
import urllib3
import click
from app.utils import all_python_files, get_repo_dir, delete_temp_dir
...
def get_unused_functions():
    ...
    # repo_location = get_repo_dir(repo_ssh_link=repo, temp_directory=temp_dir)
    # os.chdir(path=repo_location)
    _unused_functions = []
